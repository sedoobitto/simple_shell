...
## Simple Shell
The gates of shell is an ALX project, and helps students to understand the advanced
...
You need to make sure that this shell tested and guarantees work based on `gcc-4.8` and the `C90` standard.
